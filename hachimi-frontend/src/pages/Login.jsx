...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans text-slate-900 selection:bg-[#0052CC] selection:text-white">
      ...
      <div className="w-full lg:w-1/3 flex flex-col px-10 sm:px-16 lg:px-20 bg-white h-screen overflow-y-auto shadow-[-20px_0_40px_rgba(0,0,0,0.05)] z-10 relative">
        
        <div className="max-w-lg w-full mx-auto my-auto py-12">
          {/* Mobile Logo */}
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-3 py-4 bg-white border border-slate-300 rounded-2xl font-bold text-slate-700 text-lg hover:bg-slate-50 hover:border-slate-400 transition-all shadow-sm"
            >
            ...
            <button 
              type="button" 
              onClick={() => window.location.href = `${api.defaults.baseURL}/auth/github/login`}
              className="flex-1 flex items-center justify-center gap-3 py-4 bg-white border border-slate-300 rounded-2xl font-bold text-slate-700 text-lg hover:bg-slate-50 hover:border-slate-400 transition-all shadow-sm"
            >
